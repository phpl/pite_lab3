...
class TestOXGame(TestCase):
    ...
    def test_add_player(self, controller_mock):
        ...
        controller_mock.assert_called_with('[["method", "add_player_ox"], ["id", "1"], ["player_name", "test"], ["player_number", "0"]]')
    ...
    def test__init_players(self, controller_mock):
        ...
        controller_mock.assert_called_with('[["method", "add_player_ox"], ["id", "1"], ["player_name", "test"], ["player_number", "1"]]')
